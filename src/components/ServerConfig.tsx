...
export const ServerConfig: Component<ServerConfigProps> = (props) => {
  ...
  return (
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" onClick={props.onClose}>
      <div 
        class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 w-[500px]"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Server Configuration</h2>
